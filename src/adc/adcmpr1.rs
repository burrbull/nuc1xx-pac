#[doc = "Reader of register ADCMPR1"]
pub type R = crate::R<u32, super::ADCMPR1>;
#[doc = "Writer for register ADCMPR1"]
pub type W = crate::W<u32, super::ADCMPR1>;
#[doc = "Register ADCMPR1 `reset()`'s with value 0"]
impl crate::ResetValue for super::ADCMPR1 {
    type Type = u32;
    #[inline(always)]
...
with specified channel conversion result when converted data is loaded into ADDR register."]
    ...
    #[doc = "Bit 1 - Compare Interrupt Enable 1 = Enable 0 = Disable If the compare function is enabled and the compare condition matches the setting of CMPCOND and CMPMATCNT, CMPF1 bit will be asserted, in the meanwhile, if CMPIE is set to 1, a compare interrupt request is generated."]
    #[inline(always)]
    ...
    #[doc = "Bits 8:11 - Compare Match Count When the specified A/D channel analog conversion result matches the compare condition defined by CMPCOND\\[2\\], the internal match counter will increase 1. When the internal counter reaches the value to (CMPMATCNT +1), the CMPF1 bit will be set."]
    #[inline(always)]
