#[doc = "Reader of register USB_CFGP2"]
pub type R = crate::R<u32, super::USB_CFGP2>;
#[doc = "Writer for register USB_CFGP2"]
pub type W = crate::W<u32, super::USB_CFGP2>;
#[doc = "Register USB_CFGP2 `reset()`'s with value 0"]
impl crate::ResetValue for super::USB_CFGP2 {
    type Type = u32;
    #[inline(always)]
