#[doc = "Reader of register USB_MXPLD0"]
pub type R = crate::R<u32, super::USB_MXPLD0>;
#[doc = "Writer for register USB_MXPLD0"]
pub type W = crate::W<u32, super::USB_MXPLD0>;
#[doc = "Register USB_MXPLD0 `reset()`'s with value 0"]
impl crate::ResetValue for super::USB_MXPLD0 {
    type Type = u32;
    #[inline(always)]
