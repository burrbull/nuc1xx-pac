#[doc = "Reader of register USB_MXPLD3"]
pub type R = crate::R<u32, super::USB_MXPLD3>;
#[doc = "Writer for register USB_MXPLD3"]
pub type W = crate::W<u32, super::USB_MXPLD3>;
#[doc = "Register USB_MXPLD3 `reset()`'s with value 0"]
impl crate::ResetValue for super::USB_MXPLD3 {
    type Type = u32;
    #[inline(always)]
