#[doc = "Reader of register USB_MXPLD1"]
pub type R = crate::R<u32, super::USB_MXPLD1>;
#[doc = "Writer for register USB_MXPLD1"]
pub type W = crate::W<u32, super::USB_MXPLD1>;
#[doc = "Register USB_MXPLD1 `reset()`'s with value 0"]
impl crate::ResetValue for super::USB_MXPLD1 {
    type Type = u32;
    #[inline(always)]
