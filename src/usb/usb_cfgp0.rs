#[doc = "Reader of register USB_CFGP0"]
pub type R = crate::R<u32, super::USB_CFGP0>;
#[doc = "Writer for register USB_CFGP0"]
pub type W = crate::W<u32, super::USB_CFGP0>;
#[doc = "Register USB_CFGP0 `reset()`'s with value 0"]
impl crate::ResetValue for super::USB_CFGP0 {
    type Type = u32;
    #[inline(always)]
