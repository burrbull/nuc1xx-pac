#[doc = "Reader of register USB_CFGP4"]
pub type R = crate::R<u32, super::USB_CFGP4>;
#[doc = "Writer for register USB_CFGP4"]
pub type W = crate::W<u32, super::USB_CFGP4>;
#[doc = "Register USB_CFGP4 `reset()`'s with value 0"]
impl crate::ResetValue for super::USB_CFGP4 {
    type Type = u32;
    #[inline(always)]
