#[doc = "Reader of register USB_CFGP5"]
pub type R = crate::R<u32, super::USB_CFGP5>;
#[doc = "Writer for register USB_CFGP5"]
pub type W = crate::W<u32, super::USB_CFGP5>;
#[doc = "Register USB_CFGP5 `reset()`'s with value 0"]
impl crate::ResetValue for super::USB_CFGP5 {
    type Type = u32;
    #[inline(always)]
