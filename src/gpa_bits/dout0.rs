#[doc = "Reader of register DOUT0"]
pub type R = crate::R<u32, super::DOUT0>;
#[doc = "Writer for register DOUT0"]
pub type W = crate::W<u32, super::DOUT0>;
#[doc = "Register DOUT0 `reset()`'s with value 0x01"]
impl crate::ResetValue for super::DOUT0 {
    type Type = u32;
    #[inline(always)]
