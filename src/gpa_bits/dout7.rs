#[doc = "Reader of register DOUT7"]
pub type R = crate::R<u32, super::DOUT7>;
#[doc = "Writer for register DOUT7"]
pub type W = crate::W<u32, super::DOUT7>;
#[doc = "Register DOUT7 `reset()`'s with value 0x01"]
impl crate::ResetValue for super::DOUT7 {
    type Type = u32;
    #[inline(always)]
