#[doc = "Reader of register DOUT2"]
pub type R = crate::R<u32, super::DOUT2>;
#[doc = "Writer for register DOUT2"]
pub type W = crate::W<u32, super::DOUT2>;
#[doc = "Register DOUT2 `reset()`'s with value 0x01"]
impl crate::ResetValue for super::DOUT2 {
    type Type = u32;
    #[inline(always)]
