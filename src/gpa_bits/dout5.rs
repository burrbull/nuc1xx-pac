#[doc = "Reader of register DOUT5"]
pub type R = crate::R<u32, super::DOUT5>;
#[doc = "Writer for register DOUT5"]
pub type W = crate::W<u32, super::DOUT5>;
#[doc = "Register DOUT5 `reset()`'s with value 0x01"]
impl crate::ResetValue for super::DOUT5 {
    type Type = u32;
    #[inline(always)]
