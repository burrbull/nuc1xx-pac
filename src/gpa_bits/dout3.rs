#[doc = "Reader of register DOUT3"]
pub type R = crate::R<u32, super::DOUT3>;
#[doc = "Writer for register DOUT3"]
pub type W = crate::W<u32, super::DOUT3>;
#[doc = "Register DOUT3 `reset()`'s with value 0x01"]
impl crate::ResetValue for super::DOUT3 {
    type Type = u32;
    #[inline(always)]
