#[doc = "Reader of register DOUT4"]
pub type R = crate::R<u32, super::DOUT4>;
#[doc = "Writer for register DOUT4"]
pub type W = crate::W<u32, super::DOUT4>;
#[doc = "Register DOUT4 `reset()`'s with value 0x01"]
impl crate::ResetValue for super::DOUT4 {
    type Type = u32;
    #[inline(always)]
