#[doc = "Reader of register DOUT9"]
pub type R = crate::R<u32, super::DOUT9>;
#[doc = "Writer for register DOUT9"]
pub type W = crate::W<u32, super::DOUT9>;
#[doc = "Register DOUT9 `reset()`'s with value 0x01"]
impl crate::ResetValue for super::DOUT9 {
    type Type = u32;
    #[inline(always)]
