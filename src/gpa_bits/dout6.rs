#[doc = "Reader of register DOUT6"]
pub type R = crate::R<u32, super::DOUT6>;
#[doc = "Writer for register DOUT6"]
pub type W = crate::W<u32, super::DOUT6>;
#[doc = "Register DOUT6 `reset()`'s with value 0x01"]
impl crate::ResetValue for super::DOUT6 {
    type Type = u32;
    #[inline(always)]
