#[doc = "Reader of register DOUT8"]
pub type R = crate::R<u32, super::DOUT8>;
#[doc = "Writer for register DOUT8"]
pub type W = crate::W<u32, super::DOUT8>;
#[doc = "Register DOUT8 `reset()`'s with value 0x01"]
impl crate::ResetValue for super::DOUT8 {
    type Type = u32;
    #[inline(always)]
