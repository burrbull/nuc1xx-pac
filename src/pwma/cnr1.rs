#[doc = "Reader of register CNR1"]
pub type R = crate::R<u32, super::CNR1>;
#[doc = "Writer for register CNR1"]
pub type W = crate::W<u32, super::CNR1>;
#[doc = "Register CNR1 `reset()`'s with value 0"]
impl crate::ResetValue for super::CNR1 {
    type Type = u32;
    #[inline(always)]
