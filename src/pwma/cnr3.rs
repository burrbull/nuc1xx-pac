#[doc = "Reader of register CNR3"]
pub type R = crate::R<u32, super::CNR3>;
#[doc = "Writer for register CNR3"]
pub type W = crate::W<u32, super::CNR3>;
#[doc = "Register CNR3 `reset()`'s with value 0"]
impl crate::ResetValue for super::CNR3 {
    type Type = u32;
    #[inline(always)]
