#[doc = "Reader of register CNR0"]
pub type R = crate::R<u32, super::CNR0>;
#[doc = "Writer for register CNR0"]
pub type W = crate::W<u32, super::CNR0>;
#[doc = "Register CNR0 `reset()`'s with value 0"]
impl crate::ResetValue for super::CNR0 {
    type Type = u32;
    #[inline(always)]
