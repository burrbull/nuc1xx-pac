#[doc = "Reader of register CAN_IF2_CMASK"]
pub type R = crate::R<u32, super::CAN_IF2_CMASK>;
#[doc = "Writer for register CAN_IF2_CMASK"]
pub type W = crate::W<u32, super::CAN_IF2_CMASK>;
#[doc = "Register CAN_IF2_CMASK `reset()`'s with value 0"]
impl crate::ResetValue for super::CAN_IF2_CMASK {
    type Type = u32;
    #[inline(always)]
...
to IF2 Message Buffer Register. 0 = Data Bytes \\[7:4\\]
unchanged."]
    #[inline(always)]
...
to IF2 Message Buffer Register. 0 = Data Bytes \\[3:0\\]
unchanged."]
    #[inline(always)]
    ...
    #[doc = "Bit 4 - Control Access Control Bits Direction = Write 1 = Transfer Control Bits to Message Object. 0 = Control Bits unchanged Direction = Read 1 = Transfer Control Bits to IF2 Message Buffer Register. 0 = Control Bits unchanged."]
    #[inline(always)]
    pub fn control(&self) -> CONTROL_R {
        CONTROL_R::new(((self.bits >> 4) & 0x01) != 0)
    }
    #[doc = "Bit 5 - Access Arbitration Bits Direction = Write 1 = Transfer Identifier + Dir + Xtd + MsgVal to Message Object 0 = Arbitration bits unchanged. Direction = Read 1 = Transfer Identifier + Dir + Xtd + MsgVal to IF2 Message Buffer Register. 0 = Arbitration bits unchanged."]
    #[inline(always)]
    pub fn arb(&self) -> ARB_R {
        ARB_R::new(((self.bits >> 5) & 0x01) != 0)
    }
    #[doc = "Bit 6 - Access Mask Bits Direction = Write 1 = Transfer Identifier Mask + MDir + MXtd to Message Object. 0: = Mask bits unchanged. Direction = Read 1 = Transfer Identifier Mask + MDir + MXtd to IF2 Message Buffer Register. 0 = Mask bits unchanged."]
    #[inline(always)]
