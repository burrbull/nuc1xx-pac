#[doc = "Reader of register CAN_IF1_CREQ"]
pub type R = crate::R<u32, super::CAN_IF1_CREQ>;
#[doc = "Writer for register CAN_IF1_CREQ"]
pub type W = crate::W<u32, super::CAN_IF1_CREQ>;
#[doc = "Register CAN_IF1_CREQ `reset()`'s with value 0x01"]
impl crate::ResetValue for super::CAN_IF1_CREQ {
    type Type = u32;
    #[inline(always)]
...
impl R {
    ...
    #[doc = "Bit 15 - Busy Flag 1 = Writing to the IF1 Command Request Register is in progress. This bit can only be read by the software. 0 = Read/write action has finished."]
    #[inline(always)]
