#[doc = "Reader of register CAN_IF2_DAT_B1"]
pub type R = crate::R<u32, super::CAN_IF2_DAT_B1>;
#[doc = "Writer for register CAN_IF2_DAT_B1"]
pub type W = crate::W<u32, super::CAN_IF2_DAT_B1>;
#[doc = "Register CAN_IF2_DAT_B1 `reset()`'s with value 0"]
impl crate::ResetValue for super::CAN_IF2_DAT_B1 {
    type Type = u32;
    #[inline(always)]
