#[doc = "Reader of register CAN_IF1_DAT_B2"]
pub type R = crate::R<u32, super::CAN_IF1_DAT_B2>;
#[doc = "Writer for register CAN_IF1_DAT_B2"]
pub type W = crate::W<u32, super::CAN_IF1_DAT_B2>;
#[doc = "Register CAN_IF1_DAT_B2 `reset()`'s with value 0"]
impl crate::ResetValue for super::CAN_IF1_DAT_B2 {
    type Type = u32;
    #[inline(always)]
