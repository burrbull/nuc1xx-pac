#[doc = "Reader of register PS2TXDATA0"]
pub type R = crate::R<u32, super::PS2TXDATA0>;
#[doc = "Writer for register PS2TXDATA0"]
pub type W = crate::W<u32, super::PS2TXDATA0>;
#[doc = "Register PS2TXDATA0 `reset()`'s with value 0"]
impl crate::ResetValue for super::PS2TXDATA0 {
    type Type = u32;
    #[inline(always)]
